<template>
  <div>
    <v-layout wrap pt-5 justify-center>
      <v-flex
        xs8
        class="cyan--text text--darken-2 display-2 font-weight-black font-italic bgc-b"
      >Booking</v-flex>
    </v-layout>

    <v-layout wrap justify-center>
      <v-flex xs12 md4 py-3 pt-5 light class="bgc-b">
        <!-- 
          ************************
          ** Check Availability **
          ************************
          ...
          <v-flex xs6>
            ...
            <div>
              ...
              >
                ...
                <v-flex xs3>
                  <label>{{availability.date}}, {{availability.time}}</label>
                </v-flex>
              </v-layout>
            </div>
        ...
        <v-layout pt-3 row wrap justify-space-around fill-height>
          <v-flex xs6>
            <form>
              ...
              <div class="text--grey" style="text-align: left;">(Guest 1 default to be the account owner)</div>
              <v-text-field
                v-model="first_name"
                label="First Name"
                ...
                disabled
              ></v-text-field>
              <v-text-field v-model="last_name" label="Last Name" :placeholder="last_name" disabled></v-text-field>
      ...
      <v-flex xs12 md4 py-3 pt-5 light class="bgc-b">
        <v-layout row wrap justify-space-around fill-height>
          <v-flex xs6>
            ...
            >{{info.data && info.data.tour_description}}</v-flex>
      ...
      <v-flex
        ...
        xs8
        class="bgc-b"
      >By clicking on continue, you agree on the Refund Policy, the Guest Waiver, and the Cancellation Policy.</v-flex>
